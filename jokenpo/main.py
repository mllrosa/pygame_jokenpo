...
overlay_houver = pygame.Surface((largura_imagem, altura_imagem), pygame.SRCALPHA)
overlay_houver.fill((0, 0, 0, 50))
imagem_houver_pedra = imagem_pedra.copy()
imagem_houver_pedra.blit(overlay_houver, (0, 0))
imagem_houver_papel = imagem_papel.copy()
imagem_houver_papel.blit(overlay_houver, (0, 0))
imagem_houver_tesoura = imagem_tesoura.copy()
imagem_houver_tesoura.blit(overlay_houver, (0, 0))
...
imagens_houver = {"pedra": imagem_houver_pedra, "papel": imagem_houver_papel, "tesoura": imagem_houver_tesoura}
